...
class WindowSettings {
    ...
    useRoundIcon() {
        if (this.settings.getAttribute("useRoundIcon") == 'true') {
            ...
            exec("mkdir -p $HOME/.local/share/applications/ & cp /usr/share/applications/deezer-enhanced.desktop $HOME/.local/share/applications/deezer-enhanced.desktop & wget -P $HOME/.local/share/icons/hicolor/scalable/apps/ https://raw.githubusercontent.com/fischer-felix/deezer-enhanced/master/assets/deezer-round.svg & sleep 1 && sed -i 's/Icon=deezer-enhanced/Icon=deezer-round/' $HOME/.local/share/applications/deezer-enhanced.desktop", (error, stdout, stderr) => {
                if (error) {
